...
ALTER TABLE plugin_claude_token_usage_1a4b97362d.usage_events
...
UPDATE plugin_claude_token_usage_1a4b97362d.usage_events
   SET raw_model = model
...
CREATE INDEX IF NOT EXISTS usage_events_company_occurred_at_idx
  ON plugin_claude_token_usage_1a4b97362d.usage_events (company_id, occurred_at DESC);

-- Index for per-(raw_model, source) grouping.
CREATE INDEX IF NOT EXISTS usage_events_company_raw_model_idx
  ON plugin_claude_token_usage_1a4b97362d.usage_events (company_id, raw_model);
