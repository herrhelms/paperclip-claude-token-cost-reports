...
CREATE TABLE IF NOT EXISTS plugin_claude_token_cost_reports_c7ca204bbe.pricing_config_history (
...
CREATE INDEX IF NOT EXISTS pricing_config_history_company_eff_idx
  ON plugin_claude_token_cost_reports_c7ca204bbe.pricing_config_history (company_id, effective_from DESC);
